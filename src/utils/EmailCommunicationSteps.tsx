export const EmailCommunicationSteps: any = [
  ...
  <p><a href="https://members.collegeathletenetwork.org/" target="_blank" aria-label="Create My Availability (opens in a new tab)" style="margin: 10px 0 ; display:inline-block;padding:5px 10px;background-color:#ED3237;color:#ffffff;text-decoration:none;border-radius:4px;">Create My Availability</a></p>
  ...
  <p><a href="https://members.collegeathletenetwork.org/" target="_blank" aria-label="Browse Athlete Availabilities (opens in a new tab)" style="margin: 10px 0 ; display:inline-block;padding:5px 10px;background-color:#ED3237;color:#ffffff;text-decoration:none;border-radius:4px;">Browse Athlete Availabilities</a></p>
  ...
  },
  {
    ...
    body: `
        ...
        <p>Through the College Athlete Network, your company gains access to a curated, verified pool of high-performance talent—former and current athletes prepared for the workforce.</p>
        <h2>Step 1: Athletes Share Career Availabilities</h2>
        <p>Student-athletes and alumni complete short, structured profiles outlining their interests, experience, and location preferences.</p>
        <h2>Step 2: Departments Ensure Quality and Accuracy</h2>
        <p>The athletic department tracks completion and confirms that every Availability meets a standard of clarity and professionalism.</p>
        <h2>Step 3: Coaches Activate the Network</h2>
        <p>Once vetted, profiles are released to the broader Network, connecting you with an exclusive pipeline of trusted talent.</p>
        <h2>Step 4: You Match Opportunities with Purpose</h2>
        <p>Use filters to find candidates aligned with your hiring goals—whether you're focused on performance, leadership, or DEI.</p>
        <h2>Step 5: You Hire, They Excel</h2>
        <p>These candidates bring discipline, resilience, and team-first mentalities to your workforce—no recruiter required.</p>
        <h2>Step 6: You Give Back with Impact</h2>
        <p>In place of a recruiter fee, your company makes a tax-deductible contribution to the athletic program—a direct investment in the pipeline that supported your new hire.</p>
        <p>This isn't just a job board—it's a strategic partnership. The school is actively aligning its athlete community with the goals of forward-thinking companies, making it easier than ever to hire great people and give back with meaning.</p>
        <p>We invite you to explore the Network and become part of a smarter, more connected hiring approach.</p>
        <p>Sincerely,<br/>{{Your Full Name}}<br/>{{Your Title}}<br/>{{Your University}}</p>
      `,
  },
];
