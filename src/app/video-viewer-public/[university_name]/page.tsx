...
const defaultVideoId = "SWwTzuWM-EM";
...
export default function VideoViewerPage() {
  ...
  return (
    <>
      <Head>
        <title>Public Video Viewer for The College Athlete Network</title>
        <meta
          name="description"
      ...
      <div className="bg-gray-50 flex flex-col items-center pb-3">
        <div className="w-full bg-gradient-to-r from-[#1C315F] to-[#ED3237] text-white pt-20 pb-6 text-center shadow-md px-4 sm:px-6">
          <h1 className="text-2xl sm:text-4xl font-extrabold tracking-wider">
            {`Public Video Viewer for The College Athlete Network`}
          </h1>
          ...
          <p className="text-base sm:text-2xl mt-2 max-w-3xl mx-auto font-bold text-white/80">
            <strong>Innovative Athletic Departments</strong>
          </p>
        </div>
        ...
        <div className="w-full max-w-screen-lg px-4 sm:px-8 mt-4">
          ...
          <div className="mt-3 text-center text-[#1c315f]/80 text-sm">
            Engagement possibilities for the {displayedUniversityName} Athlete
            Network.
          </div>
        ...
        <div className="mt-4 px-4 text-[#1c315f] text-lg sm:text-xl font-semibold text-center">
          Ready to engage with your{" "}
          <strong>{displayedUniversityName} Athlete Network</strong>?
        </div>
        <div className="mt-3 mb-2 flex w-full flex-row flex-wrap items-center justify-center gap-3 px-4">
          <a
            href="https://www.collegeathletenetwork.org/contact-us"
