...
export const metadata = {
  ...
  description:
    "Read the Terms and Conditions for using The College Athlete Networks services, including user responsibilities, privacy, and dispute resolution.",
};
      ...
      <main className="flex-grow max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <article className="prose prose-lg max-w-none text-gray-600">
          ...
          <p className="mb-4 text-gray-600">
            ...
            necessary consents (e.g., for photos of others). If you&apos;re an
            Organization, you must post a privacy policy on your site, obtain
            user consent for data collection, and avoid sharing sensitive data
            (e.g., Social Security Numbers) unless stored securely.
          </p>
          ...
          <p className="mb-4 text-gray-600">
            We may remove User Content that violates these Terms or applicable
            laws. If your content is removed, you can appeal by contacting{" "}
            <a
              href="mailto:support@CollegeAthleteNetwork.org"
              className="text-blue-600 hover:underline"
            >
          ...
          <p className="mb-4 text-gray-600">Your notice must include:</p>
          <ul className="list-disc list-inside mb-4">
            <li>Your signature (physical or electronic).</li>
            <li>Identification of the copyrighted work.</li>
            <li>Location of the infringing material on the Service.</li>
            <li>Your contact information.</li>
            <li>
              A statement that you believe in good faith the use isn&apos;t
              authorized.
            </li>
            <li>
              A statement, under penalty of perjury, that your information is
              accurate and you&apos;re authorized to act for the copyright
              owner.
            </li>
          </ul>
          <p className="mb-4 text-gray-600">
            If your content is removed due to a DMCA notice, you may submit a
            counter-notice to the same contact, explaining why you believe the
            removal was incorrect. We may terminate accounts of repeat
            infringers.
          </p>
