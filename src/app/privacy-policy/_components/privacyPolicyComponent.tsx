...
const Section = React.forwardRef<HTMLDivElement, BoxProps>(function Section(props, ref) {
        ...
        <PrivacyContainer aria-labelledby="main-content">
          ...
          <Section component="section" aria-labelledby="definitions-heading">
            ...
            >
              ...
              means any natural or legal person who processes Personal Data on
              our behalf under our instructions, such as payment processors or
              analytics providers. For the purpose of this Privacy Policy, we
          ...
          <Section
            component="section"
            aria-labelledby="info-collection-heading"
          >
            <Typography
              component="h2"
            ...
            >
              ...
              educational, and personal contact information for our athlete
              network users. We do not wish to be contacted by users for
              purposes unrelated to the intended use of this data. We do not and
              will not sell or distribute any Personal Data to any third
              parties.
            </Typography>
            <Typography
              variant="body1"
            ...
            >
              ...
              if a university chooses to do provide us with some of their
              additional data, such data will be kept strictly confidential.
            </Typography>
          ...
          <Section component="section" aria-labelledby="retention-heading">
            ...
            >
              ...
              necessary as described in this Privacy Policy, but for no more
              then 36 months on a rolling basis. We will retain and use your
              Personal Data only to the extent necessary to comply with our
          ...
          >
            ...
            >
              ...
              facilitate our Service (“Service Providers”), provide the Service
          ...
          <Section component="section" aria-labelledby="payments-heading">
            ...
            >
              ...
              that case, we use a third-party service named Stripe for payment
          ...
          <Section component="section" aria-labelledby="children-heading">
            ...
            >
              ...
              Personal Data from children under 13 without verification of
          ...
          <Section component="section" aria-labelledby="transfer-heading">
            ...
            >
              ...
              that your Personal Data is handled securely and in accordance with
              this Privacy Policy. We will not transfer your Personal Data to
              any organization or country unless adequate safeguards are in
              place, including measures to protect the security and
              confidentiality of your data and other personal information.
            </Typography>
          </Section>
          ...
          <Section component="section" aria-labelledby="security-heading">
            ...
            >
              ...
              guarantee its absolute security. We employ access controls,
              encryption, 2-factor authentication, and other commercially
              reasonable measures to protect our data.
            </Typography>
          </Section>
