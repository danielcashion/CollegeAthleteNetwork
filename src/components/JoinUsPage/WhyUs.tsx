    ...
    <section className="py-16">
      <div className="container mx-auto px-4 max-w-[1060px] flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 md:pl-8">
          ...
          <p className="text-lg mb-4 text-[#1C315F] text-center md:text-left">
            ...
            If you&apos;re passionate about leveling the playing field and
            helping athletes transition into meaningful careers, you belong
            here.
          </p>
          <p className="text-lg text-[#1C315F] text-center md:text-left">
            We&apos;re a purpose-driven team of builders, thinkers, and former
            athletes who understand the power of connection. Every day, we work
            to unlock career pathways for student-athletes and alumni by making
            professional networks more accessible and tailored to their unique
            journeys. When you join us, you&apos;re not just taking a job —
